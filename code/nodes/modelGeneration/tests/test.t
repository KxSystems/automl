...
failingTest[.automl.modelGeneration.filesChk;inapprConfig;1b;fileError];

-1"\nTesting appropriate problem type to build models";

// Testing all appropriate problem types
all passingTest[.automl.modelGeneration.filesChk;;1b;(::)]each configList
...
-1"\nTesting appropriate target values to ensure the correct models are used";
